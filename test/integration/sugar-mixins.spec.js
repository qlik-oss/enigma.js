...
describe("Sugar mixins", () => {
  ...
  it(
    "should load script and make selections",
    () => {
      const listDef = {
        qInfo: {
      ...
      return qixGlobal
        ...
        .then(() => app.getList(listDef))
        .then((list) =>
          expect(list.qSelectionObject.qSelections[0].qSelectedCount).to.equal(
            26,
          ),
        );
    },
  ...
  it(
    "should create and list measures",
    () => {
      const listDef = {
        qInfo: {
          qType: "measureList",
  ...
  it(
    "should load script and list fields",
    () => {
      const listDef = {
        qInfo: {
          qType: "FieldList",
      ...
      return qixGlobal
        ...
        .then((list) =>
          list.qFieldList.qItems.filter((qField) => qField.qIsHidden !== true),
        )
  ...
  it(
    "should create and list dimensions",
    () => {
      const listDef = {
        qInfo: {
          qType: "dimensionList",
      ...
      return qixGlobal
        ...
        .then(() => app.getList(listDef))
        .then((list) =>
          expect(dimension.id).to.equal(
            list.qDimensionList.qItems[0].qInfo.qId,
          ),
        );
    },
    HIGH_TIMEOUT,
  ...
  it(
    ...
    () => {
      ...
      return qixGlobal
        ...
        .then(() => app.getList(listDef))
        .then((list) =>
          list.qVariableList.qItems.filter((v) => v.qIsReserved !== true),
        )
        .then((userVariables) =>
